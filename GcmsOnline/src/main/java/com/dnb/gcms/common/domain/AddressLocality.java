...
public class AddressLocality {
    ...
    public AddressLocality withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public AddressLocality withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AddressLocality) == false) {
            return false;
        }
        AddressLocality rhs = ((AddressLocality) other);
