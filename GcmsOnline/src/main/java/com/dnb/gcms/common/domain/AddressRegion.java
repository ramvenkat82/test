...
public class AddressRegion {
    ...
    public AddressRegion withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public AddressRegion withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AddressRegion) == false) {
            return false;
        }
        AddressRegion rhs = ((AddressRegion) other);
